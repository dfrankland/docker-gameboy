...
ARG LLVMGBZ80_GITHUB_USER_NAME=Bevinsky
ARG LLVMGBZ80_GITHUB_REPO_NAME=llvm-gbz80
ARG LLVMGBZ80_GITHUB_REPO_COMMIT=eae7104
...
RUN set -eux; \
  ...
  curl -L https://api.github.com/repos/$LLVMGBZ80_GITHUB_USER_NAME/$LLVMGBZ80_GITHUB_REPO_NAME/tarball/$LLVMGBZ80_GITHUB_REPO_COMMIT | tar -xvzf -; \
  ...
  \
  rsync -a /$LLVMGBZ80_GITHUB_USER_NAME-$LLVMGBZ80_GITHUB_REPO_NAME-$LLVMGBZ80_GITHUB_REPO_COMMIT/ /llvm; \
  rsync -a /$CLANG_GITHUB_USER_NAME-$CLANG_GITHUB_REPO_NAME-$CLANG_GITHUB_REPO_COMMIT/ /llvm/tools/clang; \
  \
  rm -rf \
    /$LLVMGBZ80_GITHUB_USER_NAME-$LLVMGBZ80_GITHUB_REPO_NAME-$LLVMGBZ80_GITHUB_REPO_COMMIT \
